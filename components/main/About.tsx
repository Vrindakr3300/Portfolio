            ...
            <div className="flex flex-col items-center justify-start relative md:mt-[90px] lg:mt-12 z-[20] w-auto h-auto">
                <InView triggerOnce={false}>
                    {({ inView, ref }) => (
                        ...
                        >
                            <img src="/vrinda.jpeg" alt="profile" width={250} />
                        </motion.div>
                    )}
                </InView>
...
I am a Software Developer and Computer Science undergraduate at Vellore Institute of Technology with hands-on experience in full-stack development and AI-based applications. I have worked with Java, Python, JavaScript, SQL, React, Flask, and CNNs, and developed automation systems that improved efficiency during my internship at Dixon Technologies. I enjoy solving complex problems and building scalable, production-ready solutions.                            </h1>
                        </motion.div>
                    )}
                </InView>
            </div>
